...
class LaraveloggerServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        if ($this->app->runningInConsole()) {
            ...
            $this->publishes([
                __DIR__.'/../config/config.php' => config_path('laravelogger.php'),
            ], 'config');
    ...
    public function register()
    {
        ...
        $this->mergeConfigFrom(__DIR__.'/../config/config.php', 'laravelogger');

        // Register the main class to use with the facade
        $this->app->singleton('laravelogger', function () {
            return new Logger;
        });
    }
}
